...
transition: 0.5s;
        ...
        print "&nbsp&nbsp&nbsp&nbspLatitude: " . "<br>" . $this->leaves["Latitude"] . "<br><br>" ;
        print "&nbsp&nbsp&nbsp&nbspLongitude: " . "<br>" . $this->leaves["Longitude"] . "<br><br>";
        print "</div>";
        print "<div>Timing Details<div>";
        print "&nbsp&nbsp&nbsp&nbspWhen will your event happen?" . "<br>" . $this->leaves["DateTimeStart"] . "<br><br>";
        print "&nbsp&nbsp&nbsp&nbspAnd When will it end?" . "<br>" . $this->leaves["DateTimeEnd"] . "<br><br>";
        print "</div>";
        print "<div>Pricing<div>";
        print "&nbsp&nbsp&nbsp&nbspHow much is a ticket to your event? £" . "<br>" . $this->leaves["Cost"] . "<br><br>";
        print "&nbsp&nbsp&nbsp&nbspAnd where should someone get a ticket online?" . "<br>" . $this->leaves["TicketLink"] . "<br><br>";
        print "</div>";
        print "<div>General Info<div>";
        print "&nbsp&nbsp&nbsp&nbspWhich category best describes your event?" . "<br>" . $this->leaves["Category"] . "<br><br>";
        print "&nbsp&nbsp&nbsp&nbspWhat is the name of your event?" . "<br>" . $this->leaves["Name"] . "<br><br>";
        print "&nbsp&nbsp&nbsp&nbspHow would you describe your event?" . "<br>" . $this->leaves["Description"] . "<br><br>";
        print "</div>";
